"""
Moteur de signal de trading.

Combine les prédictions des modèles avec les informations
de structure de marché et de gestion du risque.
...
class TradingSignal:
    """
    Résultat produit par le moteur de signal.
    """
...
class SignalEngine:
    ...
    Chaque prédiction doit utiliser :
    -1 = SELL
     0 = NO_TRADE
     1 = BUY
    """
    ...
    def generate_signal(
        ...
        """
        Génère un signal final à partir de plusieurs modèles.
        ...
        # Ajout des scores de structure de marché.
        normalized_structure_score = min(
            max(abs(market_structure_score) / 100, 0.0),
            1.0,
        )
    ...
    def _validate_predictions(
        ...
        """
        Vérifie que les prédictions utilisent -1, 0 ou 1.
        """
